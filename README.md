...
```python
from rium_api_client import Client
...
```python
from rium_api_client import AuthenticatedClient
...
```python
from rium_api_client.models import MyDataModel
from rium_api_client.api.my_tag import get_my_data_model
from rium_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `rium_api_client.api.default`
